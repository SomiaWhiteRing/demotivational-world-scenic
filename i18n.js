const i18n = {
  ja: {
    ...
    about: {
      title: "このサイトについて",
      description: `<p><a href="https://github.com/demotivational-world-preservation">喪界保存会</a>のプロジェクトの一つです。藻太郎先生の<a href="https://suzume4949.blogspot.com/">喪界</a>に収録された740点のイラストを保存しています。</p>
      
      <p>保存目的のみの収録となります。他の用途での使用はご遠慮ください。</p>
